...
┌─────────────────┐         ┌──────────────────┐         ┌─────────────────────┐
│                 │─attacks─▶                  │──logs───▶                     │
│  Host / Kali    │         │  Windows 10 VM   │         │  Wazuh SIEM Server  │
│  (Attacker)     │         │  (Agent)         │         │  (Ubuntu 22.04)     │
│                 │         │                  │         │                     │
└─────────────────┘         └──────────────────┘         └─────────────────────┘
│                              │
Wazuh Agent v4.7.5           Wazuh Manager 4.7.5
Wazuh Indexer
Wazuh Dashboard

**Virtualization:** VirtualBox (Host-Only Network: 192.168.56.0/24)
